...
def senet154(last_stride, pretrained=True, **kwargs):
    model = SENet(
        block=SEBottleneck,
        layers=[3, 8, 36, 3],
        groups=64,
...
def se_resnet50(last_stride, pretrained=True, **kwargs):
    model = SENet(
...
def se_resnet101(last_stride, pretrained=True, **kwargs):
    model = SENet(
        block=SEResNetBottleneck,
        layers=[3, 4, 23, 3],
        groups=1,
...
def se_resnet152(last_stride, pretrained=True, **kwargs):
    model = SENet(
        block=SEResNetBottleneck,
        layers=[3, 8, 36, 3],
        groups=1,
...
def se_resnext50_32x4d(last_stride, pretrained=True, **kwargs):
    model = SENet(
...
def se_resnext101_32x4d(last_stride, pretrained=True, **kwargs):
    model = SENet(
        block=SEResNeXtBottleneck,
        layers=[3, 4, 23, 3],
        groups=32,
