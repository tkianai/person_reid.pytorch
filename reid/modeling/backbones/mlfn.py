...
class MLFNBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride, fsm_channels, groups=32):
        ...
        self.fm_conv2 = nn.Conv2d(mid_channels, mid_channels, 3,
                                  stride=stride, padding=1, bias=False, groups=self.groups)
...
class MLFN(nn.Module):
    ...
    def __init__(self, groups=32, channels=[64, 256, 512, 1024, 2048], embed_dim=1024, **kwargs):
